  ...
  return (
    <div className='w-screen '>
        ...
        <form className='flex flex-col gap-6 items-center justify-center  my-8 px-8 md:px-12 lg:px-16 ' onSubmit={handleSubmit}>
            ...
            <div className='grid grid-cols-5 gap-4 w-full'>
                {images.map((item,index)=>{
                    ...
                    <div className='relative' key={index}>
                        ...
                        <button className="absolute top-1 right-1 bg-gray-200 rounded-full p-2" onClick={()=>handleRemove(item)} ><RiDeleteBinLine /></button>
                    </div>
            ...
            <button type='submit' className='px-4 py-2 bg-red-600 text-white font-bold'>Submit</button>
        </form>
    </div>
  )
}
